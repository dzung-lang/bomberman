...
public class Doria extends Oneal{
    ...
    public void getDoriaImage() {

        dyingImg[0] = setImg("/enemy/kondoria_dead");
        dyingImg[1] = setImg("/enemy/kondoria_dead");
        dyingImg[2] = setImg("/enemy/kondoria_dead");

        up[0] = setImg("/enemy/kondoria_right1");
        up[1] = setImg("/enemy/kondoria_right2");
        up[2] = setImg("/enemy/kondoria_right3");

        down[0] = setImg("/enemy/kondoria_left1");
        down[1] = setImg("/enemy/kondoria_left2");
        down[2] = setImg("/enemy/kondoria_left3");

        left[0] = setImg("/enemy/kondoria_left1");
        left[1] = setImg("/enemy/kondoria_left2");
        left[2] = setImg("/enemy/kondoria_left3");

        right[0] = setImg("/enemy/kondoria_right1");
        right[1] = setImg("/enemy/kondoria_right2");
        right[2] = setImg("/enemy/kondoria_right3");
    }
